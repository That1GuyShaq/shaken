    ...
    public function run(): void
    {
        $recipes = [
            [
                ...
                'tags' =>['Tequila', 'Citrus', 'Salt Rim', 'Refreshing'],
                'category' => 1,
                'user_id' => 1
            ],
            [
            ...
            [
                ...
                'tags' =>['Rum', 'Mint', 'Citrus', 'Refreshing'],
                'category' => 5,
                'user_id' => 1
            ],
            [
                ...
                'tags' =>['Vodka', 'Cranberry', 'Citrus', 'Trendy'],
                'category' => 2,
                'user_id' => 1
            ],
            [
            ...
            [
                ...
                'tags' =>['Rum', 'Coconut', 'Tropical', 'Sweet'],
                'category' => 7,
                'user_id' => 1
            ],
            [
            ...
            [
                ...
                'tags' =>['Rum', 'Tropical', 'Fruity', 'Citrus'],
                'category' => 8,
                'user_id' => 1
            ],
            [
            ...
            [
                ...
                'tags' =>['Vodka', 'Savory', 'Brunch', 'Spicy'],
                'category' => 6,
                'user_id' => 1
            ],
            [
            ...
            [
                ...
                'tags' =>['Vodka', 'Rum', 'Tequila', 'Gin', 'Strong'],
                'category' => 3,
                'user_id' => 1
            ],
            [
